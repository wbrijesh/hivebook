        ...
        return (
          <button
            ...
            className={cn(
              ...
              "flex items-center gap-2.5 rounded-lg border-2 px-3.5 py-2.5 text-left transition-colors focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-none",
              on
