...
Hivebook stores knowledge in two strata:
...
`reference/glossary.adoc` for current canonical terms.
____
...
`tenancy-and-acl.adoc` for the access model within a customer.
...
(see `design-docs/0001-continuous-ingestion-and-filing.adoc`)
