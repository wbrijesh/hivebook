...
A design doc _proposes_ — it can change, get rejected, evolve, and
be superseded. An ADR _records_ — it captures a decision at a moment
...
write two ADRs.
* Use the frontmatter from xref:ROOT:adrs/0000-template.adoc[].
